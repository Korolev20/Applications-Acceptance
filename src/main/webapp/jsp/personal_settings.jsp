...
<div id="site_content">
    ...
    <div id="content">
                        ...
                        <c:when test="${ not empty applicants}">
                            <c:forEach items="${applicants}" var="applicant">
                                <p><a style="color:black"
                                    ...
                                    №<c:out value="${applicant.enrollmentId}"/> <c:out
                                        value="${applicant.facultyName}"/> <font color=" <c:choose>
        ...
        <div style="float:right;width: 35%">
            ...
            <p class="personalData"><fmt:message key="Surname"/>: <font color="#008b8b"><c:out
                    value="${user.lastName}"/></font></p>
            <p class="personalData"><fmt:message key="Name"/>: <font color="#008b8b"><c:out
                    value="${user.firstName}"/></font></p>
            <p class="personalData"><fmt:message key="Patronymic"/>: <font color="#008b8b"><c:out
                    value="${user.patronymic}"/></font></p>
